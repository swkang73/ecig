...
rbf_svc = svm.SVC().fit(train_data, train_label)
#lin_svc = svm.SVC(kernel='linear').fit(train_data, train_label)
#poly_svc = svm.SVC(kernel='poly', degree=3).fit(train_data, train_label) # degree 3 by default
